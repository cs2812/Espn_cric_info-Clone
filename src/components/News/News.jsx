  ...
  return (
    <div className={styles.News}>
      ...
      <div className={styles.first}>
        ...
        <a
          id={styles.mb}
          href="https://www.google.com/search?q=mumbai+vs+uttar+pradesh+scorecard&rlz=1C1CHBD_enIN988IN989&oq=mum&aqs=chrome.0.69i59l2j46i67i433j69i57j0i67j46i20i263i433i512j46i131i433i512j0i512j0i433i512j0i67.3067j0j15&sourceid=chrome&ie=UTF-8#sie=m;/g/11s1sxbmq5;5;/m/04rnbt;dt;fp;1;;"
        >
          {" "}
          <div
            style={{
          ...
          >
            ...
            >
              <img
                ...
                alt=""
              />
              Uttar Pradesh <span>{"(Yet to bat)"}</span>
            </div>
          </div>
        </a>{" "}
        <hr />
        <a
          ...
          href="https://www.espncricinfo.com/series/ranji-trophy-2021-22-2022-1280196/mumbai-vs-uttar-pradesh-2nd-semi-final-1313308/live-match-blog"
        >
          {" "}
          ...
          <div className={styles.top1}>
            ...
            >
              Blog: Patidar Fifty Swells Madhya Pradesh Advantage
            </h3>
            <h4
              style={{
                color: "grey",
            ...
            >
              Mumbai have one Foot in the door to the final after Uttar Pradesh
              Collps
            </h4>
          </div>
        </a>
        <hr />
        <a
          href="https://www.espncricinfo.com/story/ranji-trophy-2022-semi-final-ben-vs-mp-how-shahbaz-ahmed-adapted-to-red-ball-cricket-1320158"
          style={{
            color: "black",
          }}
        >
          <div className={styles.top2}>
            ...
            <div className={styles.h5}>
              How Shahbaz addepted to red ball cricket
            </div>
            <div className={styles.h5}>Tamore makes the most of the chance</div>
            <div className={styles.h5}>
              Jaiswal: "i'm" tough mentally because i have to be on my toes all
              the time
            </div>
          </div>
        </a>
        ...
        <a href="https://www.hotstar.com/in/sports/cricket/south-africa-tour-of-india-2022/india-vs-south-africa-m706088/match-clips/india-crush-sa-to-bounce-back/1540016329">
          <div className={styles.container}>
      ...
      <div className={styles.first}>
        ...
        >
          Bangladesh look to abandon horrors of 2018 vs WI
        </h2>{" "}
        <hr />
        <div
          style={{
