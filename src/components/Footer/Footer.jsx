  ...
  return (
    <div id='footer'>
      <table className='table-nav'>
        ...
        <tr><td>Zimbabwe v Afganistan</td></tr>
        <tr><td>Netherland v England</td></tr>
        <tr><td>Ireland v India</td></tr>
        <tr><td>Ranji Trophy</td></tr>
        <tr><td>Vitality Blast</td></tr>
        <tr><td>County Div1</td></tr>
        <tr><td>County Div2</td></tr>
